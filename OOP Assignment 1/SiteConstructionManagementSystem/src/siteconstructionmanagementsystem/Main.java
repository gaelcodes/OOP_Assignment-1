package siteconstructionmanagementsystem;
...
public class Main {
    public static void main(String[] args) {
        ...
        do {
            // Menu
            System.out.println("\n=== SITE CONSTRUCTION MANAGEMENT MENU ===");
            ...
            switch (choice) {
                case 1:
                    ...
                    while (true) {
                        System.out.print("Enter a double (must be between 1 and 10): ");
                        if (scanner.hasNextDouble()) {
                            ...
                            if (deliveryQuantity >= 0) {
                                ...
                                System.out.println(
                                        "Invalid input! Delivered material quantity must be between 1 and 10. Please try again.");
                            }
                        } else {
                ...
                case 2:
                    ...
                    while (true) {
                        System.out.print("Enter a double (must be greater than or equal to 0): ");
                        if (scanner.hasNextDouble()) {
                            ...
                            if (usageQuantity >= 0) {
                                ...
                                System.out.println(
                                        "Invalid input! Quantity must be greater than or equal to 0. Please try again.");
                            }
                        } else {
                            System.out.println("Invalid input! Please enter a valid double.");
                    ...
                    while (true) {
                        ...
                        if (scanner.hasNextDouble()) {
                            ...
                            if (costQuantity >= 0) {
                                ...
                                System.out.println(
                                        "Invalid input! Double must be greater than or equal to 0. Please try again.");
                            }
                        } else {
                            System.out.println("Invalid input! Please enter a valid double.");
                            scanner.next(); // Clear invalid input
